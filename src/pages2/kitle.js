...
const Kitle = (props) => {
    ...
    const sonuc = Math.round(10000*Number(kilo)/(Number(value)*Number(value)));
        ...
        <SafeAreaView>
            <View style={styles.Container}>
                ...
                <ImageBackground
                    ...
                    source={{uri:"https://images.unsplash.com/photo-1602520628350-fbf9db1f02ae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"}}
                    style={styles.imageContainer}>

                    <Text style={styles.text0}>Vucut Kitle indeksi </Text>
