...
const Karbon = (props) => {
    ...
    const sonuc = Math.round(66+Number(value)*1.7+Number(kilo)*9.6-Number(age)*4.7);
        ...
        <SafeAreaView>
            <View style={styles.Container}>
                ...
                <ImageBackground
                    ...
                    source={{uri:"https://images.pexels.com/photos/1374586/pexels-photo-1374586.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"}}
                    style={styles.imageContainer}>

                    <Text style={styles.text0}>Karbonhidrat ihtiyacı</Text>
            ...
            <Text style={styles.text4}>Sonuç: {sonuc} kalori</Text>
